...
def setup_logging():
    ...
    file_handler = TimedRotatingFileHandler(
        filename=os.path.join(log_directory, 'my_log'),
        when="midnight",
        interval=1,
        backupCount=30
    )
    ...
    # Установка уровня логгирования для httpx
    logging.getLogger("httpx").setLevel(logging.WARNING)  # Или используйте logging.CRITICAL для полного отключения
